...
<button type="submit" className="loginregis"onClick={register}>Create your ForecastMall Account</button>
<h6>OR</h6>
<h4 onClick={windowSign}>Sign With Google</h4>
</form>
<p >
By sigging in you agree to ForecastMall terms and condiction.
