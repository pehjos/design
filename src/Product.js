...
function Product({setCurrentId, ship,status,country,del, post,itemdesc,video,percentage,atualp,image,cancelp,id}) {
...
<p id="delete" onClick={() => dispatch1(deletePost(post._id))}>{del}</p>
</div>
